...
import { useShoppingAgentChat } from './useAgentChat';
import ReactMarkdown from 'react-markdown';

/**
 * Chat UI component using agent-state-bridge
 * 
 * Features:
...
export const AgentChat = () => {
  ...
  const { messages, sendMessage, isLoading, error } = useShoppingAgentChat();
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 mt-8">
                ...
                <p className="text-xs mt-2">Ask me about products or your cart</p>
              </div>
            )}
